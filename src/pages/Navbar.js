...
const Navbar = () => {
  ...
  const features = [
    ...
    { name: 'Custom Questions', icon: <ClipboardList className="h-5 w-5 text-red-500" />, path: '#' },
    { name: 'Dashboards', icon: <LayoutDashboard className="h-5 w-5 text-indigo-500" />, path: '#' },
  ];
